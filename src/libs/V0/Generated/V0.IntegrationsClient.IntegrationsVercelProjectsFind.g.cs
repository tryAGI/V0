...
namespace V0
{
    public partial class IntegrationsClient
    {
        ...
        private static readonly global::V0.EndPointSecurityRequirement s_IntegrationsVercelProjectsFindSecurityRequirement0 =
        ...
        private static readonly global::V0.EndPointSecurityRequirement[] s_IntegrationsVercelProjectsFindSecurityRequirements =
            new global::V0.EndPointSecurityRequirement[]
            {                s_IntegrationsVercelProjectsFindSecurityRequirement0,
            };
        partial void PrepareIntegrationsVercelProjectsFindArguments(
            global::System.Net.Http.HttpClient httpClient);
        partial void PrepareIntegrationsVercelProjectsFindRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage);
        partial void ProcessIntegrationsVercelProjectsFindResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessIntegrationsVercelProjectsFindResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::V0.IntegrationsVercelProjectsFindResponse> IntegrationsVercelProjectsFindAsync(
            global::V0.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await IntegrationsVercelProjectsFindAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::V0.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::V0.AutoSDKHttpResponse<global::V0.IntegrationsVercelProjectsFindResponse>> IntegrationsVercelProjectsFindAsResponseAsync(
            global::V0.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareIntegrationsVercelProjectsFindArguments(
                httpClient: HttpClient);


            var __authorizations = global::V0.EndPointSecurityResolver.ResolveAuthorizations(
                availableAuthorizations: Authorizations,
                securityRequirements: s_IntegrationsVercelProjectsFindSecurityRequirements,
                operationName: "IntegrationsVercelProjectsFindAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareIntegrationsVercelProjectsFindRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::V0.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::V0.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "IntegrationsVercelProjectsFind",
                                methodName: "IntegrationsVercelProjectsFindAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessIntegrationsVercelProjectsFindResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::V0.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessIntegrationsVercelProjectsFindResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::V0.IntegrationsVercelProjectsFindResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::V0.AutoSDKHttpResponse<global::V0.IntegrationsVercelProjectsFindResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::V0.IntegrationsVercelProjectsFindResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
