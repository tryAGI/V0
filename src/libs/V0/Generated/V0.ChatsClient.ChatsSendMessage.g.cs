...
namespace V0
{
    public partial class ChatsClient
    {
        ...
        private static readonly global::V0.EndPointSecurityRequirement s_ChatsSendMessageSecurityRequirement0 =
        ...
        private static readonly global::V0.EndPointSecurityRequirement[] s_ChatsSendMessageSecurityRequirements =
            new global::V0.EndPointSecurityRequirement[]
            {                s_ChatsSendMessageSecurityRequirement0,
            };
        partial void PrepareChatsSendMessageArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string chatId,
            global::V0.ChatsSendMessageRequest request);
        partial void PrepareChatsSendMessageRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string chatId,
            global::V0.ChatsSendMessageRequest request);
        partial void ProcessChatsSendMessageResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessChatsSendMessageResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::V0.ChatDetail> ChatsSendMessageAsync(
            string chatId,
        ...
        {
            var __response = await ChatsSendMessageAsResponseAsync(
                chatId: chatId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::V0.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::V0.AutoSDKHttpResponse<global::V0.ChatDetail>> ChatsSendMessageAsResponseAsync(
            string chatId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareChatsSendMessageArguments(
            ...
            var __authorizations = global::V0.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ChatsSendMessageSecurityRequirements,
                operationName: "ChatsSendMessageAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::V0.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::V0.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ChatsSendMessage",
                                methodName: "ChatsSendMessageAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessChatsSendMessageResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::V0.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessChatsSendMessageResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<global::V0.ChatDetail> ChatsSendMessageAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::V0.ChatsSendMessageRequest
            {
                Message = message,
            ...
            return await ChatsSendMessageAsync(
                chatId: chatId,
                request: __request,
                requestOptions: requestOptions,
