...
namespace V0
{
    public partial class ChatsClient
    {
        ...
        private static readonly global::V0.EndPointSecurityRequirement s_ChatsDeleteVersionFilesSecurityRequirement0 =
        ...
        private static readonly global::V0.EndPointSecurityRequirement[] s_ChatsDeleteVersionFilesSecurityRequirements =
            new global::V0.EndPointSecurityRequirement[]
            {                s_ChatsDeleteVersionFilesSecurityRequirement0,
            };
        partial void PrepareChatsDeleteVersionFilesArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string chatId,
            ref string versionId,
            global::V0.ChatsDeleteVersionFilesRequest request);
        partial void PrepareChatsDeleteVersionFilesRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string chatId,
            string versionId,
            global::V0.ChatsDeleteVersionFilesRequest request);
        partial void ProcessChatsDeleteVersionFilesResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessChatsDeleteVersionFilesResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::V0.VersionDetail> ChatsDeleteVersionFilesAsync(
            string chatId,
            string versionId,
        ...
        {
            var __response = await ChatsDeleteVersionFilesAsResponseAsync(
                chatId: chatId,
                versionId: versionId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::V0.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::V0.AutoSDKHttpResponse<global::V0.VersionDetail>> ChatsDeleteVersionFilesAsResponseAsync(
            string chatId,
            string versionId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareChatsDeleteVersionFilesArguments(
            ...
            var __authorizations = global::V0.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ChatsDeleteVersionFilesSecurityRequirements,
                operationName: "ChatsDeleteVersionFilesAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::V0.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::V0.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ChatsDeleteVersionFiles",
                                methodName: "ChatsDeleteVersionFilesAsync",
                                pathTemplate: "$\"/chats/{chatId}/versions/{versionId}/files/delete\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessChatsDeleteVersionFilesResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::V0.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessChatsDeleteVersionFilesResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<global::V0.VersionDetail> ChatsDeleteVersionFilesAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::V0.ChatsDeleteVersionFilesRequest
            {
                FilePaths = filePaths,
            };

            return await ChatsDeleteVersionFilesAsync(
                chatId: chatId,
                versionId: versionId,
                request: __request,
                requestOptions: requestOptions,
