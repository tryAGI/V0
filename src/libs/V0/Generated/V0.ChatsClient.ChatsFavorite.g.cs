...
namespace V0
{
    public partial class ChatsClient
    {
        ...
        private static readonly global::V0.EndPointSecurityRequirement s_ChatsFavoriteSecurityRequirement0 =
        ...
        private static readonly global::V0.EndPointSecurityRequirement[] s_ChatsFavoriteSecurityRequirements =
            new global::V0.EndPointSecurityRequirement[]
            {                s_ChatsFavoriteSecurityRequirement0,
            };
        partial void PrepareChatsFavoriteArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string chatId,
            global::V0.ChatsFavoriteRequest request);
        partial void PrepareChatsFavoriteRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string chatId,
            global::V0.ChatsFavoriteRequest request);
        partial void ProcessChatsFavoriteResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessChatsFavoriteResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::V0.ChatsFavoriteResponse> ChatsFavoriteAsync(
            string chatId,
        ...
        {
            var __response = await ChatsFavoriteAsResponseAsync(
                chatId: chatId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::V0.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::V0.AutoSDKHttpResponse<global::V0.ChatsFavoriteResponse>> ChatsFavoriteAsResponseAsync(
            string chatId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::V0.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ChatsFavoriteSecurityRequirements,
                operationName: "ChatsFavoriteAsync");
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::V0.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::V0.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ChatsFavorite",
                                methodName: "ChatsFavoriteAsync",
                                pathTemplate: "$\"/chats/{chatId}/favorite\"",
                                httpMethod: "PUT",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                else
                {
                    await global::V0.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessChatsFavoriteResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::V0.ChatsFavoriteResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::V0.AutoSDKHttpResponse<global::V0.ChatsFavoriteResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::V0.ChatsFavoriteResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::V0.ChatsFavoriteResponse> ChatsFavoriteAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::V0.ChatsFavoriteRequest
            {
                IsFavorite = isFavorite,
            };

            return await ChatsFavoriteAsync(
                chatId: chatId,
                request: __request,
                requestOptions: requestOptions,
