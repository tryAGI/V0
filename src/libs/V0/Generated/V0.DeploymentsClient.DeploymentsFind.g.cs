...
namespace V0
{
    public partial class DeploymentsClient
    {
        ...
        private static readonly global::V0.EndPointSecurityRequirement s_DeploymentsFindSecurityRequirement0 =
        ...
        private static readonly global::V0.EndPointSecurityRequirement[] s_DeploymentsFindSecurityRequirements =
            new global::V0.EndPointSecurityRequirement[]
            {                s_DeploymentsFindSecurityRequirement0,
            };
        ...
        partial void ProcessDeploymentsFindResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        {
            var __response = await DeploymentsFindAsResponseAsync(
                chatId: chatId,
                versionId: versionId,
                projectId: projectId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::V0.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::V0.AutoSDKHttpResponse<global::V0.DeploymentsFindResponse>> DeploymentsFindAsResponseAsync(
            string chatId,
            string versionId,
            string? projectId = default,
            global::V0.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareDeploymentsFindArguments(
            ...
            var __authorizations = global::V0.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_DeploymentsFindSecurityRequirements,
                operationName: "DeploymentsFindAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::V0.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::V0.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "DeploymentsFind",
                                methodName: "DeploymentsFindAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessDeploymentsFindResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::V0.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessDeploymentsFindResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::V0.DeploymentsFindResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::V0.AutoSDKHttpResponse<global::V0.DeploymentsFindResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::V0.DeploymentsFindResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
