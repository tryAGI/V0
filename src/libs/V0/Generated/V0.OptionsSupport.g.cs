...
namespace V0
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::V0.AutoSDKRetryOptions Retry { get; set; } = new global::V0.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::V0.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::V0.IAutoSDKHook>();
        ...
        public global::V0.AutoSDKClientOptions AddHook(
            global::V0.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::V0.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::V0.AutoSDKClientOptions UseAuthorizationProvider(
            global::V0.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::V0.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::V0.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::V0.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::V0.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::V0.AutoSDKAuthorizationValue>?> ResolveAsync(
            global::V0.AutoSDKHookContext context);
    }
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::V0.AutoSDKHook
    {
        /// <inheritdoc />
            ...
            global::V0.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::V0.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::V0.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::V0.AutoSDKRetryOptions? Retry { get; set; }
        ...
        /// </summary>
        public global::System.Collections.Generic.IReadOnlyList<global::V0.AutoSDKAuthorizationValue>? Authorizations { get; set; }
    }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::V0.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::V0.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::V0.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    {
        internal static global::V0.AutoSDKHookContext CreateHookContext(
            string operationId,
            string methodName,
            string pathTemplate,
            string httpMethod,
            ...
            global::V0.AutoSDKClientOptions clientOptions,
            global::V0.AutoSDKRequestOptions? requestOptions,
            int attempt,
            int maxAttempts,
            bool willRetry,
        ...
        {
            return new global::V0.AutoSDKHookContext
            {
        ...
        internal static global::System.TimeSpan GetRetryDelay(
            ...
            int attempt)
        {
            var retryOptions = requestOptions?.Retry ?? clientOptions.Retry ?? new global::V0.AutoSDKRetryOptions();
        ...
        private static global::System.TimeSpan ClampRetryDelay(
            global::System.TimeSpan delay,
            global::V0.AutoSDKRetryOptions retryOptions)
        {
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::V0.AutoSDKClientOptions clientOptions,
            global::System.Func<global::V0.IAutoSDKHook, global::V0.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::V0.AutoSDKHookContext context)
        {
