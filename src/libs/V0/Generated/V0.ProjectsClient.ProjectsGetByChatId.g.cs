...
namespace V0
{
    public partial class ProjectsClient
    {
        ...
        private static readonly global::V0.EndPointSecurityRequirement s_ProjectsGetByChatIdSecurityRequirement0 =
        ...
        private static readonly global::V0.EndPointSecurityRequirement[] s_ProjectsGetByChatIdSecurityRequirements =
            new global::V0.EndPointSecurityRequirement[]
            {                s_ProjectsGetByChatIdSecurityRequirement0,
            };
        partial void PrepareProjectsGetByChatIdArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string chatId);
        partial void PrepareProjectsGetByChatIdRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string chatId);
        partial void ProcessProjectsGetByChatIdResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessProjectsGetByChatIdResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::V0.ProjectDetail> ProjectsGetByChatIdAsync(
            string chatId,
            global::V0.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await ProjectsGetByChatIdAsResponseAsync(
                chatId: chatId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::V0.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::V0.AutoSDKHttpResponse<global::V0.ProjectDetail>> ProjectsGetByChatIdAsResponseAsync(
            string chatId,
            global::V0.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareProjectsGetByChatIdArguments(
            ...
            var __authorizations = global::V0.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ProjectsGetByChatIdSecurityRequirements,
                operationName: "ProjectsGetByChatIdAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareProjectsGetByChatIdRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::V0.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::V0.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ProjectsGetByChatId",
                                methodName: "ProjectsGetByChatIdAsync",
                                pathTemplate: "$\"/chats/{chatId}/project\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessProjectsGetByChatIdResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::V0.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessProjectsGetByChatIdResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::V0.ProjectDetail.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::V0.AutoSDKHttpResponse<global::V0.ProjectDetail>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::V0.ProjectDetail.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
