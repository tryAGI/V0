...
namespace V0
{
    public partial class ProjectsClient
    {
        ...
        private static readonly global::V0.EndPointSecurityRequirement s_ProjectsGetEnvVarSecurityRequirement0 =
        ...
        private static readonly global::V0.EndPointSecurityRequirement[] s_ProjectsGetEnvVarSecurityRequirements =
            new global::V0.EndPointSecurityRequirement[]
            {                s_ProjectsGetEnvVarSecurityRequirement0,
            };
        partial void PrepareProjectsGetEnvVarArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string projectId,
            ref string environmentVariableId,
            ref global::V0.ProjectsGetEnvVarDecrypted? decrypted);
        partial void PrepareProjectsGetEnvVarRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string projectId,
            string environmentVariableId,
            global::V0.ProjectsGetEnvVarDecrypted? decrypted);
        partial void ProcessProjectsGetEnvVarResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessProjectsGetEnvVarResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::V0.ProjectsGetEnvVarResponse> ProjectsGetEnvVarAsync(
            string projectId,
            string environmentVariableId,
        ...
        {
            var __response = await ProjectsGetEnvVarAsResponseAsync(
                projectId: projectId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::V0.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::V0.AutoSDKHttpResponse<global::V0.ProjectsGetEnvVarResponse>> ProjectsGetEnvVarAsResponseAsync(
            string projectId,
            string environmentVariableId,
            global::V0.ProjectsGetEnvVarDecrypted? decrypted = default,
            global::V0.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareProjectsGetEnvVarArguments(
                httpClient: HttpClient,
                projectId: ref projectId,
                environmentVariableId: ref environmentVariableId,
                decrypted: ref decrypted);


            var __authorizations = global::V0.EndPointSecurityResolver.ResolveAuthorizations(
                availableAuthorizations: Authorizations,
                securityRequirements: s_ProjectsGetEnvVarSecurityRequirements,
                operationName: "ProjectsGetEnvVarAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::V0.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::V0.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ProjectsGetEnvVar",
                                methodName: "ProjectsGetEnvVarAsync",
                                pathTemplate: "$\"/projects/{projectId}/env-vars/{environmentVariableId}\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessProjectsGetEnvVarResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::V0.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessProjectsGetEnvVarResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::V0.ProjectsGetEnvVarResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::V0.AutoSDKHttpResponse<global::V0.ProjectsGetEnvVarResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::V0.ProjectsGetEnvVarResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
