...
namespace V0
{
    public partial class ProjectsClient
    {
        ...
        private static readonly global::V0.EndPointSecurityRequirement s_ProjectsFindEnvVarsSecurityRequirement0 =
        ...
        private static readonly global::V0.EndPointSecurityRequirement[] s_ProjectsFindEnvVarsSecurityRequirements =
            new global::V0.EndPointSecurityRequirement[]
            {                s_ProjectsFindEnvVarsSecurityRequirement0,
            };
        partial void PrepareProjectsFindEnvVarsArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string projectId,
            ref global::V0.ProjectsFindEnvVarsDecrypted? decrypted);
        partial void PrepareProjectsFindEnvVarsRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string projectId,
            global::V0.ProjectsFindEnvVarsDecrypted? decrypted);
        partial void ProcessProjectsFindEnvVarsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessProjectsFindEnvVarsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::V0.ProjectsFindEnvVarsResponse> ProjectsFindEnvVarsAsync(
            string projectId,
            global::V0.ProjectsFindEnvVarsDecrypted? decrypted = default,
            global::V0.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await ProjectsFindEnvVarsAsResponseAsync(
                projectId: projectId,
                decrypted: decrypted,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::V0.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::V0.AutoSDKHttpResponse<global::V0.ProjectsFindEnvVarsResponse>> ProjectsFindEnvVarsAsResponseAsync(
            string projectId,
            global::V0.ProjectsFindEnvVarsDecrypted? decrypted = default,
            global::V0.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareProjectsFindEnvVarsArguments(
            ...
            var __authorizations = global::V0.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ProjectsFindEnvVarsSecurityRequirements,
                operationName: "ProjectsFindEnvVarsAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::V0.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::V0.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ProjectsFindEnvVars",
                                methodName: "ProjectsFindEnvVarsAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessProjectsFindEnvVarsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::V0.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessProjectsFindEnvVarsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::V0.ProjectsFindEnvVarsResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::V0.AutoSDKHttpResponse<global::V0.ProjectsFindEnvVarsResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::V0.ProjectsFindEnvVarsResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
