...
namespace V0
{
    public partial class ChatsClient
    {
        ...
        private static readonly global::V0.EndPointSecurityRequirement s_ChatsGetMessageSecurityRequirement0 =
        ...
        private static readonly global::V0.EndPointSecurityRequirement[] s_ChatsGetMessageSecurityRequirements =
            new global::V0.EndPointSecurityRequirement[]
            {                s_ChatsGetMessageSecurityRequirement0,
            };
        partial void PrepareChatsGetMessageArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string chatId,
            ref string messageId);
        partial void PrepareChatsGetMessageRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string chatId,
            string messageId);
        partial void ProcessChatsGetMessageResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessChatsGetMessageResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::V0.MessageDetail> ChatsGetMessageAsync(
            string chatId,
            string messageId,
            global::V0.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await ChatsGetMessageAsResponseAsync(
                chatId: chatId,
                messageId: messageId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::V0.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::V0.AutoSDKHttpResponse<global::V0.MessageDetail>> ChatsGetMessageAsResponseAsync(
            string chatId,
            string messageId,
            global::V0.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareChatsGetMessageArguments(
            ...
            var __authorizations = global::V0.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ChatsGetMessageSecurityRequirements,
                operationName: "ChatsGetMessageAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::V0.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::V0.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ChatsGetMessage",
                                methodName: "ChatsGetMessageAsync",
                                pathTemplate: "$\"/chats/{chatId}/messages/{messageId}\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessChatsGetMessageResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::V0.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessChatsGetMessageResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::V0.MessageDetail.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::V0.AutoSDKHttpResponse<global::V0.MessageDetail>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::V0.MessageDetail.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
