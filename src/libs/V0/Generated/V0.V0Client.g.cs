...
namespace V0
{
    ...
    public sealed partial class V0Client : global::V0.IV0Client, global::System.IDisposable
    {
        ...
        /// <inheritdoc/>
        public global::System.Collections.Generic.List<global::V0.EndPointAuthorization> Authorizations { get; }
        ...
        /// <inheritdoc/>
        public global::V0.AutoSDKClientOptions Options { get; }
        /// <summary>
        /// 
        /// </summary>
        public global::System.Text.Json.Serialization.JsonSerializerContext JsonSerializerContext { get; set; } = global::V0.SourceGenerationContext.Default;
        ...
        /// 
        /// </summary>
        public HooksClient Hooks => new HooksClient(HttpClient, authorizations: Authorizations, options: Options)
        {
            ReadResponseAsString = ReadResponseAsString,
            JsonSerializerContext = JsonSerializerContext,
        };
        ...
        /// 
        /// </summary>
        public RateLimitsClient RateLimits => new RateLimitsClient(HttpClient, authorizations: Authorizations, options: Options)
        {
            ReadResponseAsString = ReadResponseAsString,
            JsonSerializerContext = JsonSerializerContext,
        };
        ...
        public V0Client(
            ...
            global::System.Collections.Generic.List<global::V0.EndPointAuthorization>? authorizations = null,
        ...
        public V0Client(
            ...
            global::System.Uri? baseUri = null,
            global::System.Collections.Generic.List<global::V0.EndPointAuthorization>? authorizations = null,
            global::V0.AutoSDKClientOptions? options = null,
            bool disposeHttpClient = true)
        {

            HttpClient = httpClient ?? new global::System.Net.Http.HttpClient();
            HttpClient.BaseAddress ??= baseUri ?? new global::System.Uri(DefaultBaseUrl);
            Authorizations = authorizations ?? new global::System.Collections.Generic.List<global::V0.EndPointAuthorization>();
            Options = options ?? new global::V0.AutoSDKClientOptions();
