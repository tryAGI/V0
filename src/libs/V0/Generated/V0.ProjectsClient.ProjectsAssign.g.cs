...
namespace V0
{
    public partial class ProjectsClient
    {
        ...
        private static readonly global::V0.EndPointSecurityRequirement s_ProjectsAssignSecurityRequirement0 =
        ...
        private static readonly global::V0.EndPointSecurityRequirement[] s_ProjectsAssignSecurityRequirements =
            new global::V0.EndPointSecurityRequirement[]
            {                s_ProjectsAssignSecurityRequirement0,
            };
        partial void PrepareProjectsAssignArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string projectId,
            global::V0.ProjectsAssignRequest request);
        partial void PrepareProjectsAssignRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string projectId,
            global::V0.ProjectsAssignRequest request);
        partial void ProcessProjectsAssignResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessProjectsAssignResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::V0.ProjectsAssignResponse> ProjectsAssignAsync(
            string projectId,
        ...
        {
            var __response = await ProjectsAssignAsResponseAsync(
                projectId: projectId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::V0.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::V0.AutoSDKHttpResponse<global::V0.ProjectsAssignResponse>> ProjectsAssignAsResponseAsync(
            string projectId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareProjectsAssignArguments(
            ...
            var __authorizations = global::V0.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ProjectsAssignSecurityRequirements,
                operationName: "ProjectsAssignAsync");
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::V0.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::V0.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ProjectsAssign",
                                methodName: "ProjectsAssignAsync",
                                pathTemplate: "$\"/projects/{projectId}/assign\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                else
                {
                    await global::V0.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessProjectsAssignResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::V0.ProjectsAssignResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::V0.AutoSDKHttpResponse<global::V0.ProjectsAssignResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::V0.ProjectsAssignResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::V0.ProjectsAssignResponse> ProjectsAssignAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::V0.ProjectsAssignRequest
            {
                ChatId = chatId,
            };

            return await ProjectsAssignAsync(
                projectId: projectId,
                request: __request,
                requestOptions: requestOptions,
