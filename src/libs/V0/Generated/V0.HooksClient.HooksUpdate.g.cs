...
namespace V0
{
    public partial class HooksClient
    {


        private static readonly global::V0.EndPointSecurityRequirement s_HooksUpdateSecurityRequirement0 =
        ...
        private static readonly global::V0.EndPointSecurityRequirement[] s_HooksUpdateSecurityRequirements =
            new global::V0.EndPointSecurityRequirement[]
            {                s_HooksUpdateSecurityRequirement0,
            };
        partial void PrepareHooksUpdateArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string hookId,
            global::V0.HooksUpdateRequest request);
        partial void PrepareHooksUpdateRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string hookId,
            global::V0.HooksUpdateRequest request);
        partial void ProcessHooksUpdateResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessHooksUpdateResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::V0.HookDetail> HooksUpdateAsync(
            string hookId,
        ...
        {
            var __response = await HooksUpdateAsResponseAsync(
                hookId: hookId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::V0.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::V0.AutoSDKHttpResponse<global::V0.HookDetail>> HooksUpdateAsResponseAsync(
            string hookId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::V0.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_HooksUpdateSecurityRequirements,
                operationName: "HooksUpdateAsync");
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::V0.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::V0.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "HooksUpdate",
                                methodName: "HooksUpdateAsync",
                                pathTemplate: "$\"/hooks/{hookId}\"",
                                httpMethod: "PATCH",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                else
                {
                    await global::V0.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessHooksUpdateResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::V0.HookDetail.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::V0.AutoSDKHttpResponse<global::V0.HookDetail>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::V0.HookDetail.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::V0.HookDetail> HooksUpdateAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::V0.HooksUpdateRequest
            {
                Name = name,
                Events = events,
                Url = url,
